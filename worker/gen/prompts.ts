...
export const CONTENT_RULE = `Content rule: no depiction, planning or reward of atrocities in bills, storylets, headlines or quotes. If the scenario seats the player in a regime defined by atrocities, keep the period and seat the player in the nearest governing seat that can be played at the strategic level, and say what you moved or left out in content_note. The factions that carried out a historical atrocity may exist as factions, named as historians name them; their members are written as ordinary politicians of the period doing ordinary political work, never as heroes and never glorified.
...
- chamber: size 24 to 100. threshold is the simple majority of size, supermajority the two-thirds or the era's rule. alpha is the weight of public opinion in the end test, 0 to 1. veto is null unless one class of seat can freeze a bill.
- Chamber size: when the real body has a known seat count, use round(real_size ÷ 8) clamped to 24..100 (a 736-seat parliament becomes 92, a 300-seat senate 38, a 60-member council 24); when the body has no fixed size, choose inside 24..100 by how many named factions and regions the era carries.
