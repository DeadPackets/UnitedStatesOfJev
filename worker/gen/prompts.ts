...
export const CONTENT_RULE = `Content rule: this is a historical simulation of power, written the way historians and serious strategy games write it. Seat the player in the real office of that year, whatever the regime. Name real rulers, parties, ideologies, symbols and events plainly, and state the period's wars, purges and atrocities as history, never euphemised and never glorified. Play covers war, invasion, coups, purges of rivals, martial law, censorship and repression. The one thing never written as play: an act, card, effect or reward in which the ruler plans or carries out mass violence against civilians or the persecution of a people. Force never gets tactical detail of violence.
